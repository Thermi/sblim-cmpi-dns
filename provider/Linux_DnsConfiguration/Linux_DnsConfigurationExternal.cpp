...
namespace genProvider {
  ...
  Linux_DnsConfigurationExternal::~Linux_DnsConfigurationExternal() { }
	...
	//----------------------------------------------------------------------------
  void 
  Linux_DnsConfigurationExternal::enumInstanceNames(
    const char *aNameSpaceP,
    Linux_DnsConfigurationInstanceNameEnumeration& anInstanceNameEnumeration) {

    CmpiObjectPath classObjectPath(aNameSpaceP,"Linux_DnsConfiguration");
    CmpiEnumeration cmpiEnumeration = 
      m_broker.enumInstanceNames(m_context,classObjectPath);
    while (cmpiEnumeration.hasNext()) {
      CmpiObjectPath objectPath = cmpiEnumeration.getNext();
      Linux_DnsConfigurationInstanceName instanceName(objectPath);
  ...
  //----------------------------------------------------------------------------
  void
  Linux_DnsConfigurationExternal::enumInstances(
    const char *aNameSpaceP,
  ...
  Linux_DnsConfigurationExternal::getInstance(
    ...
    return Linux_DnsConfigurationInstance(cmpiInstance,anInstanceName.getNamespace());
  
  }
      
	//----------------------------------------------------------------------------
  void
  Linux_DnsConfigurationExternal::setInstance(
    const char** aPropertiesPP,
  ...
  Linux_DnsConfigurationExternal::createInstance(
    const Linux_DnsConfigurationInstance& anInstance) {
	...
	//----------------------------------------------------------------------------
  void
  Linux_DnsConfigurationExternal::deleteInstance(
    const Linux_DnsConfigurationInstanceName& anInstanceName) {
