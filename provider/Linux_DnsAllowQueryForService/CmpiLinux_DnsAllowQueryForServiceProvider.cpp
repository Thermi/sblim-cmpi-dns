...
//
// 
#include "CmpiLinux_DnsAllowQueryForServiceProvider.h"
...
namespace genProvider {
  ...
  //----------------------------------------------------------------------------
  CmpiLinux_DnsAllowQueryForServiceProvider::CmpiLinux_DnsAllowQueryForServiceProvider(
    ...
    m_interfaceP = Linux_DnsAllowQueryForServiceFactory::getImplementation();           
  ...
  //----------------------------------------------------------------------------
  int 
  CmpiLinux_DnsAllowQueryForServiceProvider::isUnloadable() const {
    return 0;
  }
	
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_DnsAllowQueryForServiceProvider::completeInstance(
    const Linux_DnsAllowQueryForServiceInstanceName& anInstanceName,
    CmpiInstance& anInstance, 
    const CmpiContext& aContext) {
	  	
    Linux_DnsAllowQueryForServiceInstanceName shadowInstanceName(anInstanceName);
  ...
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_DnsAllowQueryForServiceProvider::copyShadowData(
  ...
  //----------------------------------------------------------------------------
  CmpiInstance* 
  CmpiLinux_DnsAllowQueryForServiceProvider::getShadowInstance(
  ...
  //----------------------------------------------------------------------------
  void
  CmpiLinux_DnsAllowQueryForServiceProvider::removeDanglingShadowInstances (
   const Linux_DnsAllowQueryForServiceInstanceNameEnumeration& anInstanceNameEnumerations) {
  ...
  //                          Provider Factory
  //----------------------------------------------------------------------------
  CMProviderBase(CmpiLinux_DnsAllowQueryForServiceProvider);

  CMInstanceMIFactory(
    CmpiLinux_DnsAllowQueryForServiceProvider, 
    CmpiLinux_DnsAllowQueryForServiceProvider);

  CMMethodMIFactory(
    CmpiLinux_DnsAllowQueryForServiceProvider, 
    CmpiLinux_DnsAllowQueryForServiceProvider);    CMAssociationMIFactory(
      CmpiLinux_DnsAllowQueryForServiceProvider,
      CmpiLinux_DnsAllowQueryForServiceProvider);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAllowQueryForServiceProvider::enumInstanceNames(
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    ...
    Linux_DnsAllowQueryForServiceInstanceNameEnumeration enumeration;
    ...
    while (enumeration.hasNext() ){
      const Linux_DnsAllowQueryForServiceInstanceName& instanceName = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAllowQueryForServiceProvider::enumInstances(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop, 
    ...
    Linux_DnsAllowQueryForServiceManualInstanceEnumeration enumeration;
    ...
    while (enumeration.hasNext()) {
   	  const Linux_DnsAllowQueryForServiceManualInstance& instance = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAllowQueryForServiceProvider::getInstance (
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char** aPropertiesPP) {
    ...
    Linux_DnsAllowQueryForServiceInstanceName instanceName(aCop);
    
//    CmpiInstance* repositoryCmpiInstanceP = 0;
//    
//    // try to fetch repository instance
//    try {
//      Linux_DnsAllowQueryForServiceInstanceName repositoryInstanceName(instanceName);
...
//    } catch (const CmpiStatus& rc) { }                             
    ...
    Linux_DnsAllowQueryForServiceManualInstance instance;
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAllowQueryForServiceProvider::createInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const CmpiInstance& aCmpiInstance) {
   	
   	Linux_DnsAllowQueryForServiceManualInstance manualInstance(
      aCmpiInstance,
...
//   	  Linux_DnsAllowQueryForServiceRepositoryInstance(aCmpiInstance,"IBMShadow/cimv2").getCmpiInstance(0);     
//     
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAllowQueryForServiceProvider::setInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const CmpiInstance& aCmpiInstance,
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_DnsAllowQueryForServiceProvider::deleteInstance(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop) {
      
    Linux_DnsAllowQueryForServiceInstanceName instanceName = Linux_DnsAllowQueryForServiceInstanceName(aCop);
...
//    } catch (CmpiStatus& rc) {}
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_DnsAllowQueryForServiceProvider::invokeMethod(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAllowQueryForServiceProvider::associationLogic( 
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    ...
    if( aReferenceFlag == 0 && anInstanceFlag == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_DnsAllowQueryForServiceManualInstance manualInstance = enumeration.getNext();

        const Linux_DnsAllowQueryForServiceInstanceName instanceName = manualInstance.getInstanceName();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAllowQueryForServiceProvider::associators(
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop, 
...
#ifdef DEBUG
    std::cout << "calling associators() of class Linux_DnsAllowQueryForService" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAllowQueryForServiceProvider::associatorNames(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling associatorNames() of class Linux_DnsAllowQueryForService" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_DnsAllowQueryForServiceProvider::references( 
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling aReferenceFlag() of class Linux_DnsAllowQueryForService" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_DnsAllowQueryForServiceProvider::referenceNames(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling referenceNames() of class Linux_DnsAllowQueryForService" << std::endl;
#endif    
