...
//
// 
#ifndef CmpiLinux_DnsServiceSettingDataForServiceConfigurationProvider_h
#define CmpiLinux_DnsServiceSettingDataForServiceConfigurationProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsServiceSettingDataForServiceConfigurationFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_DnsServiceSettingDataForServiceConfigurationProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsServiceSettingDataForServiceConfigurationInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsServiceSettingDataForServiceConfigurationInstanceName& anInstanceNameP,
