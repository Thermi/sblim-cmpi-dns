...
//
// 
#ifndef Linux_DnsAllowQueryForZoneDefaultImplementation_h
#define Linux_DnsAllowQueryForZoneDefaultImplementation_h
...
#include "Linux_DnsAllowQueryForZoneInterface.h"


namespace genProvider {

  class Linux_DnsAllowQueryForZoneDefaultImplementation:
   public Linux_DnsAllowQueryForZoneInterface {
  	
    public:    
    virtual ~Linux_DnsAllowQueryForZoneDefaultImplementation() { };
