// =======================================================================
// CmpiLinux_DnsAllowNotifyForZoneProvider.h
...
//
// 
#ifndef CmpiLinux_DnsAllowNotifyForZoneProvider_h
#define CmpiLinux_DnsAllowNotifyForZoneProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsAllowNotifyForZoneFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_DnsAllowNotifyForZoneProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsAllowNotifyForZoneInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsAllowNotifyForZoneInstanceName& anInstanceNameP,
