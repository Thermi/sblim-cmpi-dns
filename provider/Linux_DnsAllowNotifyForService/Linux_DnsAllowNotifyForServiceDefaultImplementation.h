// =======================================================================
// Linux_DnsAllowNotifyForServiceDefaultImplementation.h
...
//
// 
#ifndef Linux_DnsAllowNotifyForServiceDefaultImplementation_h
#define Linux_DnsAllowNotifyForServiceDefaultImplementation_h
...
namespace genProvider {
  ...
  class Linux_DnsAllowNotifyForServiceDefaultImplementation:
   public Linux_DnsAllowNotifyForServiceInterface {
  	
    public:    
    virtual ~Linux_DnsAllowNotifyForServiceDefaultImplementation() { };
