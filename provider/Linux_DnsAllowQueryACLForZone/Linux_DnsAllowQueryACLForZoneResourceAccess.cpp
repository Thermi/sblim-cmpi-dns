...
namespace genProvider {
  ...
  //----------------------------------------------------------------------------
  void
  Linux_DnsAllowQueryACLForZoneResourceAccess::enumInstanceNames(
...
#ifdef DEBUG
    cout << "entering Linux_DnsAllowQueryACLForZone::enumInstanceNames" << endl;
#endif
    ...
    if ( ! zones) {
#ifdef DEBUG
    cout << "exiting Linux_DnsAllowQueryACLForZone::enumInstanceNames" << endl;
#endif
      return;
    }
  ...
  void
  Linux_DnsAllowQueryACLForZoneResourceAccess::enumInstances(
    const CmpiContext& aContext,
    const CmpiBroker& aBroker,
    const char* aNameSpaceP,
  ...
  /*
  void
  Linux_DnsAllowQueryACLForZoneResourceAccess::setInstance(
     const CmpiContext& aContext,
     const CmpiBroker& aBroker,
     const char** aPropertiesPP,
  ...
  */
  ...
  Linux_DnsAllowQueryACLForZoneResourceAccess::createInstance(
    const CmpiContext& aContext,
    const CmpiBroker& aBroker,
    const Linux_DnsAllowQueryACLForZoneManualInstance& aManualInstance) {
  ...
  void
  Linux_DnsAllowQueryACLForZoneResourceAccess::deleteInstance(
    const CmpiContext& aContext,
    const CmpiBroker& aBroker,
    const Linux_DnsAllowQueryACLForZoneInstanceName& anInstanceName) {
