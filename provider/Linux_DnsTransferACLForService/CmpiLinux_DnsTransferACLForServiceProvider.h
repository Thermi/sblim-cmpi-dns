 /**
 * CmpiLinux_DnsTransferACLForServiceProvider.h
 *
 ...
 *
 */
#ifndef CmpiLinux_DnsTransferACLForServiceProvider_h
#define CmpiLinux_DnsTransferACLForServiceProvider_h
...
#include "CmpiAssociationMI.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_DnsTransferACLForServiceProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_DnsTransferACLForServiceInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_DnsTransferACLForServiceInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_DnsTransferACLForServiceInstanceName& intanceName);
