...
//
// 
#ifndef CmpiLinux_DnsAddressMatchListsForServiceProvider_h
#define CmpiLinux_DnsAddressMatchListsForServiceProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsAddressMatchListsForServiceFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_DnsAddressMatchListsForServiceProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsAddressMatchListsForServiceInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsAddressMatchListsForServiceInstanceName& anInstanceNameP,
