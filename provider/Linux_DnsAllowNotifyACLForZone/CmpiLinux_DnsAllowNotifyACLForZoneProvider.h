 /**
 * CmpiLinux_DnsAllowNotifyACLForZoneProvider.h
 *
 ...
 *
 */
#ifndef CmpiLinux_DnsAllowNotifyACLForZoneProvider_h
#define CmpiLinux_DnsAllowNotifyACLForZoneProvider_h
...
#include "CmpiAssociationMI.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_DnsAllowNotifyACLForZoneProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_DnsAllowNotifyACLForZoneInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_DnsAllowNotifyACLForZoneInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_DnsAllowNotifyACLForZoneInstanceName& intanceName);
