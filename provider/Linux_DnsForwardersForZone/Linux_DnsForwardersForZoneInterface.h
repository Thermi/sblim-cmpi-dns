...
//
// 
#ifndef Linux_DnsForwardersForZoneInterface_h
#define Linux_DnsForwardersForZoneInterface_h
...
namespace genProvider {
  ...
  class Linux_DnsForwardersForZoneInterface {
  	
    public:    
    virtual ~Linux_DnsForwardersForZoneInterface() { };
    ...
    virtual void enumInstanceNames(
      ...
      Linux_DnsForwardersForZoneInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_DnsForwardersForZoneManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_DnsForwardersForZoneManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_DnsForwardersForZoneInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_DnsForwardersForZoneManualInstance& aManualInstance) = 0;
