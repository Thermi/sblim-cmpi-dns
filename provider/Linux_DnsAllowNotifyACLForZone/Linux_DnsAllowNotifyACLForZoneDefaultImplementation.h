 /**
 * Linux_DnsAllowNotifyACLForZoneDefaultImplementation.h
 *
 ...
 *
 */
#ifndef Linux_DnsAllowNotifyACLForZoneDefaultImplementation_h
#define Linux_DnsAllowNotifyACLForZoneDefaultImplementation_h
...
namespace genProvider {
  ...
  class Linux_DnsAllowNotifyACLForZoneDefaultImplementation:
   public Linux_DnsAllowNotifyACLForZoneInterface {
  	
    public:    
    virtual ~Linux_DnsAllowNotifyACLForZoneDefaultImplementation() { };
