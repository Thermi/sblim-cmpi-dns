...
//
// 
#ifndef Linux_DnsForwardersForServiceResourceAccess_h
#define Linux_DnsForwardersForServiceResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_DnsForwardersForServiceResourceAccess:
   public Linux_DnsForwardersForServiceDefaultImplementation {
  	
    public:
    /*
    Linux_DnsForwardersForServiceResourceAccess();
    */    
    virtual ~Linux_DnsForwardersForServiceResourceAccess() ;
