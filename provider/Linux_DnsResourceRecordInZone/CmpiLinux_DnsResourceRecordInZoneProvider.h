...
namespace genProvider{
  ...
  class CmpiLinux_DnsResourceRecordInZoneProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsResourceRecordInZoneInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsResourceRecordInZoneInstanceName& anInstanceNameP,
