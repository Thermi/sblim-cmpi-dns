...
namespace genProvider {
  ...
  Linux_DnsMasterZoneResourceAccess::getInstance(
    ...
    if ( strcmp(myZone->zoneType,"master")!= 0) {
      freeZones(zones);
      throw CmpiStatus(CMPI_RC_ERR_NOT_FOUND,"The specified ZoneType is not a master");
    }
  ...
  Linux_DnsMasterZoneResourceAccess::setInstance(
    ...
    if ( strcmp(myZone->zoneType,"master") != 0 ) {
      freeZones(zones);
      throw CmpiStatus(CMPI_RC_ERR_INVALID_PARAMETER,"The specified ZoneType is not a master");
    }
  ...
  Linux_DnsMasterZoneResourceAccess::createInstance(
    ...
    if (aManualInstance.isTypeSet() && aManualInstance.getType() != DNS_ZONETYPE_MASTER) {
    ...
    if (newZone) {
      ...
      newZone->zoneType = strdup("master");
      addOptsToZone( newZone, "type", "master" );
  ...
  Linux_DnsMasterZoneResourceAccess::deleteInstance(
    ...
    if ( strcmp(zone->zoneType,"master")==0 ) {
