// =======================================================================
// Linux_DnsAllowNotifyForServiceResourceAccess.h
...
//
// 
#ifndef Linux_DnsAllowNotifyForServiceResourceAccess_h
#define Linux_DnsAllowNotifyForServiceResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_DnsAllowNotifyForServiceResourceAccess:
   public Linux_DnsAllowNotifyForServiceDefaultImplementation {
  	
    public:
    /*
    Linux_DnsAllowNotifyForServiceResourceAccess();
    */    
    virtual ~Linux_DnsAllowNotifyForServiceResourceAccess() ;
