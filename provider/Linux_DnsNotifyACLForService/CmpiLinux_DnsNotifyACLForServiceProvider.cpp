...
namespace genProvider {
  ...
  CmpiLinux_DnsNotifyACLForServiceProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_DnsNotifyACLForServiceFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_DnsNotifyACLForServiceProvider::
  ...
  int CmpiLinux_DnsNotifyACLForServiceProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_DnsNotifyACLForServiceProvider::completeInstance(
   const Linux_DnsNotifyACLForServiceInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_DnsNotifyACLForServiceInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_DnsNotifyACLForServiceProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_DnsNotifyACLForServiceProvider::
  ...
  void CmpiLinux_DnsNotifyACLForServiceProvider::removeDanglingShadowInstances (
   const Linux_DnsNotifyACLForServiceInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_DnsNotifyACLForServiceProvider, CmpiLinux_DnsNotifyACLForServiceProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_DnsNotifyACLForServiceProvider,
     CmpiLinux_DnsNotifyACLForServiceProvider);
  ...
  CmpiStatus CmpiLinux_DnsNotifyACLForServiceProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_DnsNotifyACLForServiceProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_DnsNotifyACLForServiceProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_DnsNotifyACLForServiceInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsNotifyACLForServiceProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   ...
   /* 
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_DnsNotifyACLForServiceRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_DnsNotifyACLForServiceProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_DnsNotifyACLForServiceProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_DnsNotifyACLForServiceInstanceName instanceName=
     Linux_DnsNotifyACLForServiceInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsNotifyACLForServiceProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_DnsNotifyACLForServiceInstanceName instanceName=
     Linux_DnsNotifyACLForServiceInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_DnsNotifyACLForServiceProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_DnsNotifyACLForServiceManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_DnsNotifyACLForServiceProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_DnsNotifyACLForService"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsNotifyACLForServiceProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_DnsNotifyACLForService"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsNotifyACLForServiceProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_DnsNotifyACLForService"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsNotifyACLForServiceProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_DnsNotifyACLForService"<<endl;
