...
//
// 
#ifndef Linux_DnsResourceRecordDefaultImplementation_h
#define Linux_DnsResourceRecordDefaultImplementation_h
...
namespace genProvider {
  ...
  class Linux_DnsResourceRecordDefaultImplementation:
   public Linux_DnsResourceRecordInterface {
  	
    public:    
    virtual ~Linux_DnsResourceRecordDefaultImplementation() { };
