...
//
// 
#ifndef Linux_DnsServiceSettingDataForServiceConfigurationResourceAccess_h
#define Linux_DnsServiceSettingDataForServiceConfigurationResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_DnsServiceSettingDataForServiceConfigurationResourceAccess:
   public Linux_DnsServiceSettingDataForServiceConfigurationDefaultImplementation {
  	
    public:
    /*
    Linux_DnsServiceSettingDataForServiceConfigurationResourceAccess();
    */    
    virtual ~Linux_DnsServiceSettingDataForServiceConfigurationResourceAccess() ;
