...
//
// 
#ifndef Linux_DnsForwardersResourceAccess_h
#define Linux_DnsForwardersResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_DnsForwardersResourceAccess:
   public Linux_DnsForwardersDefaultImplementation {
  	
    public:
    /*
    Linux_DnsForwardersResourceAccess();
    */    
    virtual ~Linux_DnsForwardersResourceAccess() ;
