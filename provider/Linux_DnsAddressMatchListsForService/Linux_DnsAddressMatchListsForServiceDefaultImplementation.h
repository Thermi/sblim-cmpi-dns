...
//
// 
#ifndef Linux_DnsAddressMatchListsForServiceDefaultImplementation_h
#define Linux_DnsAddressMatchListsForServiceDefaultImplementation_h
...
namespace genProvider {
  ...
  class Linux_DnsAddressMatchListsForServiceDefaultImplementation:
   public Linux_DnsAddressMatchListsForServiceInterface {
  	
    public:    
    virtual ~Linux_DnsAddressMatchListsForServiceDefaultImplementation() { };
