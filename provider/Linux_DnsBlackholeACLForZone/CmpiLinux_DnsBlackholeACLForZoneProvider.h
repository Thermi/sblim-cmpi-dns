// =======================================================================
// CmpiLinux_DnsBlackholeACLForZoneProvider.h
...
//
// 
#ifndef CmpiLinux_DnsBlackholeACLForZoneProvider_h
#define CmpiLinux_DnsBlackholeACLForZoneProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsBlackholeACLForZoneFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_DnsBlackholeACLForZoneProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsBlackholeACLForZoneInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsBlackholeACLForZoneInstanceName& anInstanceNameP,
