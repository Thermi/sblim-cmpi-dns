 /**
 * CmpiLinux_DnsSettingProvider.h
 *
 ...
 *
 */
#ifndef CmpiLinux_DnsSettingProvider_h
#define CmpiLinux_DnsSettingProvider_h
...
#include "Linux_DnsSettingFactory.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_DnsSettingProvider : public CmpiInstanceMI,
   public CmpiMethodMI{	
	
	private:

	Linux_DnsSettingInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_DnsSettingInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_DnsSettingInstanceName& intanceName);
