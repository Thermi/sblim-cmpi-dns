...
//
// 
#ifndef CmpiLinux_DnsForwardersForServiceProvider_h
#define CmpiLinux_DnsForwardersForServiceProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsForwardersForServiceFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_DnsForwardersForServiceProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsForwardersForServiceInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsForwardersForServiceInstanceName& anInstanceNameP,
