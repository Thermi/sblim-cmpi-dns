// =======================================================================
// Linux_DnsAllowNotifyForZoneResourceAccess.h
...
//
// 
#ifndef Linux_DnsAllowNotifyForZoneResourceAccess_h
#define Linux_DnsAllowNotifyForZoneResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_DnsAllowNotifyForZoneResourceAccess:
   public Linux_DnsAllowNotifyForZoneDefaultImplementation {
  	
    public:
    /*
    Linux_DnsAllowNotifyForZoneResourceAccess();
    */    
    virtual ~Linux_DnsAllowNotifyForZoneResourceAccess() ;
