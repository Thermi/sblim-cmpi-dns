...
namespace genProvider{
  ...
  class CmpiLinux_DnsAllowTransferACLForZoneProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsAllowTransferACLForZoneInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsAllowTransferACLForZoneInstanceName& anInstanceNameP,
