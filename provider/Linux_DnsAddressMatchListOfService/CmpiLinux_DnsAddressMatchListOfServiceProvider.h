 /**
 * CmpiLinux_DnsAddressMatchListOfServiceProvider.h
 *
 ...
 *
 */
#ifndef CmpiLinux_DnsAddressMatchListOfServiceProvider_h
#define CmpiLinux_DnsAddressMatchListOfServiceProvider_h
...
#include "CmpiAssociationMI.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_DnsAddressMatchListOfServiceProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_DnsAddressMatchListOfServiceInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_DnsAddressMatchListOfServiceInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_DnsAddressMatchListOfServiceInstanceName& intanceName);
