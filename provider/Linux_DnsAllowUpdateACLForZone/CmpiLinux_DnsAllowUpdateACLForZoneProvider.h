...
namespace genProvider{
  ...
  class CmpiLinux_DnsAllowUpdateACLForZoneProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsAllowUpdateACLForZoneInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsAllowUpdateACLForZoneInstanceName& anInstanceNameP,
