...
namespace genProvider {
  ...
  CmpiLinux_DnsResourceRecordProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_DnsResourceRecordFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_DnsResourceRecordProvider::
  ...
  int CmpiLinux_DnsResourceRecordProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_DnsResourceRecordProvider::completeInstance(
   const Linux_DnsResourceRecordInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_DnsResourceRecordInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_DnsResourceRecordProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_DnsResourceRecordProvider::
  ...
  void CmpiLinux_DnsResourceRecordProvider::removeDanglingShadowInstances (
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
    ...
    while ( enumeration.hasNext() ){
   	  ...
   	  const Linux_DnsResourceRecordManualInstance& instance=
       enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_DnsResourceRecordInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,const CmpiInstance& inst){
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_DnsResourceRecordRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
    ...
    */
    ...
    op.setKey("ZoneName","redplanet.de");
    op.setKey("Type",6);
    op.setKey("Value","1");
    rslt.returnData(op); */
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_DnsResourceRecordInstanceName instanceName=
     Linux_DnsResourceRecordInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_DnsResourceRecordInstanceName instanceName=
     Linux_DnsResourceRecordInstanceName(ref);
