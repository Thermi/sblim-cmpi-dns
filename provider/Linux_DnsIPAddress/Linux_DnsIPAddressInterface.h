 ...
 *
 */
#ifndef Linux_DnsIPAddressInterface_h
#define Linux_DnsIPAddressInterface_h
...
namespace genProvider {
  ...
  class Linux_DnsIPAddressInterface {
  	
    public:    
    virtual ~Linux_DnsIPAddressInterface() { };
    ...
    virtual void enumInstanceNames(
     ...
     const char *nsp,
     Linux_DnsIPAddressInstanceNameEnumeration& instnames) = 0;
    ...
    virtual void enumInstances(
     ...
     const char* *properties,
  	 Linux_DnsIPAddressManualInstanceEnumeration& instances) = 0;
  	
    virtual Linux_DnsIPAddressManualInstance getInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_DnsIPAddressInstanceName&) = 0;
  	
    virtual void setInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_DnsIPAddressManualInstance&) = 0;
