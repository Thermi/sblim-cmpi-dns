...
namespace genProvider {
  ...
  CmpiLinux_DnsMastersOfSlaveZoneProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_DnsMastersOfSlaveZoneFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_DnsMastersOfSlaveZoneProvider::
  ...
  int CmpiLinux_DnsMastersOfSlaveZoneProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_DnsMastersOfSlaveZoneProvider::completeInstance(
   const Linux_DnsMastersOfSlaveZoneInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_DnsMastersOfSlaveZoneInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_DnsMastersOfSlaveZoneProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_DnsMastersOfSlaveZoneProvider::
  ...
  void CmpiLinux_DnsMastersOfSlaveZoneProvider::removeDanglingShadowInstances (
   const Linux_DnsMastersOfSlaveZoneInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_DnsMastersOfSlaveZoneProvider, CmpiLinux_DnsMastersOfSlaveZoneProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_DnsMastersOfSlaveZoneProvider,
     CmpiLinux_DnsMastersOfSlaveZoneProvider);
  ...
  CmpiStatus CmpiLinux_DnsMastersOfSlaveZoneProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_DnsMastersOfSlaveZoneProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_DnsMastersOfSlaveZoneProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_DnsMastersOfSlaveZoneInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsMastersOfSlaveZoneProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,const CmpiInstance& inst){
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_DnsMastersOfSlaveZoneRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_DnsMastersOfSlaveZoneProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_DnsMastersOfSlaveZoneProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_DnsMastersOfSlaveZoneInstanceName instanceName=
     Linux_DnsMastersOfSlaveZoneInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsMastersOfSlaveZoneProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_DnsMastersOfSlaveZoneInstanceName instanceName=
     Linux_DnsMastersOfSlaveZoneInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_DnsMastersOfSlaveZoneProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      if(cop.classPathIsA("Linux_DnsSlaveZone")) {
        Linux_DnsIPAddressInstanceEnumeration enumeration;
        Linux_DnsSlaveZoneInstanceName Element(cop);
      ...
      else if(cop.classPathIsA("Linux_DnsIPAddress")) {
        Linux_DnsSlaveZoneInstanceEnumeration enumeration;
        Linux_DnsIPAddressInstanceName Setting(cop);
      ...
      if(cop.classPathIsA("Linux_DnsIPAddress")) {
        Linux_DnsIPAddressInstanceName Setting(cop);
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_DnsMastersOfSlaveZoneManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_DnsMastersOfSlaveZoneProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_DnsMastersOfSlaveZone"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsMastersOfSlaveZoneProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_DnsMastersOfSlaveZone"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsMastersOfSlaveZoneProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_DnsMastersOfSlaveZone"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsMastersOfSlaveZoneProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_DnsMastersOfSlaveZone"<<endl;
