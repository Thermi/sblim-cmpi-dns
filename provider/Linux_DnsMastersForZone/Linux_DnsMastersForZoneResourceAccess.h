...
//
// 
#ifndef Linux_DnsMastersForZoneResourceAccess_h
#define Linux_DnsMastersForZoneResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_DnsMastersForZoneResourceAccess:
   public Linux_DnsMastersForZoneDefaultImplementation {
  	
    public:
    /*
    Linux_DnsMastersForZoneResourceAccess();
    */    
    virtual ~Linux_DnsMastersForZoneResourceAccess() ;
