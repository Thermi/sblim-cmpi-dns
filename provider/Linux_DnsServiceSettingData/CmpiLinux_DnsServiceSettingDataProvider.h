...
//
// 
#ifndef CmpiLinux_DnsServiceSettingDataProvider_h
#define CmpiLinux_DnsServiceSettingDataProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsServiceSettingDataFactory.h"


namespace genProvider{

  class CmpiLinux_DnsServiceSettingDataProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI {	
	
	  private:
	  Linux_DnsServiceSettingDataInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsServiceSettingDataInstanceName& anInstanceNameP,
