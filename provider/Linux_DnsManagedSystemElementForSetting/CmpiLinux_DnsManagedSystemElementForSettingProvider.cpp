// =======================================================================
// CmpiLinux_DnsManagedSystemElementForSettingProvider.cpp
...
//
// 
#include "CmpiLinux_DnsManagedSystemElementForSettingProvider.h"
...
namespace genProvider {
  ...
  //----------------------------------------------------------------------------
  CmpiLinux_DnsManagedSystemElementForSettingProvider::CmpiLinux_DnsManagedSystemElementForSettingProvider(
    ...
    m_interfaceP = Linux_DnsManagedSystemElementForSettingFactory::getImplementation();           
  ...
  //----------------------------------------------------------------------------
  int 
  CmpiLinux_DnsManagedSystemElementForSettingProvider::isUnloadable() const {
    return 0;
  }
	
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_DnsManagedSystemElementForSettingProvider::completeInstance(
    const Linux_DnsManagedSystemElementForSettingInstanceName& anInstanceName,
    CmpiInstance& anInstance, 
    const CmpiContext& aContext) {
	  	
    Linux_DnsManagedSystemElementForSettingInstanceName shadowInstanceName(anInstanceName);
  ...
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_DnsManagedSystemElementForSettingProvider::copyShadowData(
  ...
  //----------------------------------------------------------------------------
  CmpiInstance* 
  CmpiLinux_DnsManagedSystemElementForSettingProvider::getShadowInstance(
  ...
  //----------------------------------------------------------------------------
  void
  CmpiLinux_DnsManagedSystemElementForSettingProvider::removeDanglingShadowInstances (
   const Linux_DnsManagedSystemElementForSettingInstanceNameEnumeration& anInstanceNameEnumerations) {
  ...
  //                          Provider Factory
  //----------------------------------------------------------------------------
  CMProviderBase(CmpiLinux_DnsManagedSystemElementForSettingProvider);
  ...
  CMMethodMIFactory(
    CmpiLinux_DnsManagedSystemElementForSettingProvider, 
    CmpiLinux_DnsManagedSystemElementForSettingProvider);    CMAssociationMIFactory(
      CmpiLinux_DnsManagedSystemElementForSettingProvider,
      CmpiLinux_DnsManagedSystemElementForSettingProvider);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsManagedSystemElementForSettingProvider::enumInstanceNames(
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    ...
    Linux_DnsManagedSystemElementForSettingInstanceNameEnumeration enumeration;
    ...
    while (enumeration.hasNext() ){
      const Linux_DnsManagedSystemElementForSettingInstanceName& instanceName = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsManagedSystemElementForSettingProvider::enumInstances(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop, 
    ...
    while (enumeration.hasNext()) {
   	  const Linux_DnsManagedSystemElementForSettingManualInstance& instance = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsManagedSystemElementForSettingProvider::getInstance (
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char** aPropertiesPP) {
    ...
    Linux_DnsManagedSystemElementForSettingInstanceName instanceName(aCop);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsManagedSystemElementForSettingProvider::createInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
...
//   	  Linux_DnsManagedSystemElementForSettingRepositoryInstance(aCmpiInstance,"IBMShadow/cimv2").getCmpiInstance(0);     
//     
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsManagedSystemElementForSettingProvider::setInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const CmpiInstance& aCmpiInstance,
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_DnsManagedSystemElementForSettingProvider::deleteInstance(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop) {
      
    Linux_DnsManagedSystemElementForSettingInstanceName instanceName = Linux_DnsManagedSystemElementForSettingInstanceName(aCop);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_DnsManagedSystemElementForSettingProvider::invokeMethod(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsManagedSystemElementForSettingProvider::associationLogic( 
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    ...
    if( aReferenceFlag == 0 && anInstanceFlag == 1 ) {
      ...
      if (aCop.classPathIsA("Linux_DnsAddressMatchList")) {
        ...
        Linux_DnsAddressMatchListInstanceName Setting(aCop);
      ...
      } else if(aCop.classPathIsA("Linux_DnsZone")) {
        
        Linux_DnsAddressMatchListInstanceEnumeration enumeration;
        Linux_DnsZoneInstanceName Element(aCop);
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_DnsManagedSystemElementForSettingManualInstance manualInstance = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsManagedSystemElementForSettingProvider::associators(
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop, 
...
#ifdef DEBUG
    std::cout << "calling associators() of class Linux_DnsManagedSystemElementForSetting" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsManagedSystemElementForSettingProvider::associatorNames(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling associatorNames() of class Linux_DnsManagedSystemElementForSetting" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_DnsManagedSystemElementForSettingProvider::references( 
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling aReferenceFlag() of class Linux_DnsManagedSystemElementForSetting" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_DnsManagedSystemElementForSettingProvider::referenceNames(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling referenceNames() of class Linux_DnsManagedSystemElementForSetting" << std::endl;
#endif    
