...
//
// 
#ifndef Linux_DnsMastersForZoneRepositoryExternal_h
#define Linux_DnsMastersForZoneRepositoryExternal_h
...
namespace genProvider {
  ...
  class Linux_DnsMastersForZoneRepositoryExternal {
    ...
    public:
    Linux_DnsMastersForZoneRepositoryExternal(
      const CmpiBroker& aBroker,
      const CmpiContext& aContext);
    virtual ~Linux_DnsMastersForZoneRepositoryExternal();
    ...
    virtual Linux_DnsMastersForZoneRepositoryInstance getInstance(
      const char** aPropertiesPP,
