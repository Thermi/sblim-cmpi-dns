 /**
 * Linux_DnsRecursionACLForServiceResourceAccess.h
 *
 ...
 *
 */
#ifndef Linux_DnsRecursionACLForServiceResourceAccess_h
#define Linux_DnsRecursionACLForServiceResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_DnsRecursionACLForServiceResourceAccess:
   public Linux_DnsRecursionACLForServiceDefaultImplementation {
  	
    public:
    /*Linux_DnsRecursionACLForServiceResourceAccess(); */   
    virtual ~Linux_DnsRecursionACLForServiceResourceAccess() ;
