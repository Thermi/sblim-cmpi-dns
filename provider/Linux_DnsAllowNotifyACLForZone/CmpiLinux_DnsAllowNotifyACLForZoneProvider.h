...
namespace genProvider{
  ...
  class CmpiLinux_DnsAllowNotifyACLForZoneProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsAllowNotifyACLForZoneInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsAllowNotifyACLForZoneInstanceName& anInstanceNameP,
