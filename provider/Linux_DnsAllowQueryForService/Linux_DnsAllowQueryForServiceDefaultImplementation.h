...
//
// 
#ifndef Linux_DnsAllowQueryForServiceDefaultImplementation_h
#define Linux_DnsAllowQueryForServiceDefaultImplementation_h
...
namespace genProvider {
  ...
  class Linux_DnsAllowQueryForServiceDefaultImplementation:
   public Linux_DnsAllowQueryForServiceInterface {
  	
    public:    
    virtual ~Linux_DnsAllowQueryForServiceDefaultImplementation() { };
