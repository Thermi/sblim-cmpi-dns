// =======================================================================
// CmpiLinux_DnsAllowNotifyForServiceProvider.h
...
//
// 
#ifndef CmpiLinux_DnsAllowNotifyForServiceProvider_h
#define CmpiLinux_DnsAllowNotifyForServiceProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsAllowNotifyForServiceFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_DnsAllowNotifyForServiceProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsAllowNotifyForServiceInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsAllowNotifyForServiceInstanceName& anInstanceNameP,
