...
namespace genProvider{
  ...
  class CmpiLinux_DnsAllowQueryACLForZoneProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsAllowQueryACLForZoneInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsAllowQueryACLForZoneInstanceName& anInstanceNameP,
