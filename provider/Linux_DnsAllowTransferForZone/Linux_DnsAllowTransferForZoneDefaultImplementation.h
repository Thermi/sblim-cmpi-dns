...
//
// 
#ifndef Linux_DnsAllowTransferForZoneDefaultImplementation_h
#define Linux_DnsAllowTransferForZoneDefaultImplementation_h
...
namespace genProvider {
  ...
  class Linux_DnsAllowTransferForZoneDefaultImplementation:
   public Linux_DnsAllowTransferForZoneInterface {
  	
    public:    
    virtual ~Linux_DnsAllowTransferForZoneDefaultImplementation() { };
