 ...
 *
 */
#ifndef Linux_DnsZoneInterface_h
#define Linux_DnsZoneInterface_h
...
namespace genProvider {
  ...
  class Linux_DnsZoneInterface {
  	
    public:    
    virtual ~Linux_DnsZoneInterface() { };
    ...
    virtual void enumInstanceNames(
     ...
     const char *nsp,
     Linux_DnsZoneInstanceNameEnumeration& instnames) = 0;
    ...
    virtual void enumInstances(
     ...
     const char* *properties,
  	 Linux_DnsZoneManualInstanceEnumeration& instances) = 0;
  	
    virtual Linux_DnsZoneManualInstance getInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_DnsZoneInstanceName&) = 0;
  	
    virtual void setInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_DnsZoneManualInstance&) = 0;
