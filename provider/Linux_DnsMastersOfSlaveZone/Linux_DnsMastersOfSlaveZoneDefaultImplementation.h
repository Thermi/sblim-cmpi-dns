// =======================================================================
// Linux_DnsMastersOfSlaveZoneDefaultImplementation.h
...
//
// 
#ifndef Linux_DnsMastersOfSlaveZoneDefaultImplementation_h
#define Linux_DnsMastersOfSlaveZoneDefaultImplementation_h
...
namespace genProvider {
  ...
  class Linux_DnsMastersOfSlaveZoneDefaultImplementation:
   public Linux_DnsMastersOfSlaveZoneInterface {
  	
    public:    
    virtual ~Linux_DnsMastersOfSlaveZoneDefaultImplementation() { };
