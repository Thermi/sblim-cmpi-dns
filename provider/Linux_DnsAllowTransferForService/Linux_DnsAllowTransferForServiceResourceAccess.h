...
//
// 
#ifndef Linux_DnsAllowTransferForServiceResourceAccess_h
#define Linux_DnsAllowTransferForServiceResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_DnsAllowTransferForServiceResourceAccess:
   public Linux_DnsAllowTransferForServiceDefaultImplementation {
  	
    public:
    /*
    Linux_DnsAllowTransferForServiceResourceAccess();
    */    
    virtual ~Linux_DnsAllowTransferForServiceResourceAccess() ;
