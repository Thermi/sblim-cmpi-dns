 /**
 * CmpiLinux_DnsNotifyACLForServiceProvider.h
 *
 ...
 *
 */
#ifndef CmpiLinux_DnsNotifyACLForServiceProvider_h
#define CmpiLinux_DnsNotifyACLForServiceProvider_h

#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsNotifyACLForServiceFactory.h"
#include "CmpiAssociationMI.h"

 namespace genProvider{

  class CmpiLinux_DnsNotifyACLForServiceProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_DnsNotifyACLForServiceInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_DnsNotifyACLForServiceInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_DnsNotifyACLForServiceInstanceName& intanceName);
