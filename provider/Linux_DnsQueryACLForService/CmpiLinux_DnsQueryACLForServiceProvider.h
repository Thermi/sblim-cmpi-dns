 /**
 * CmpiLinux_DnsQueryACLForServiceProvider.h
 *
 ...
 *
 */
#ifndef CmpiLinux_DnsQueryACLForServiceProvider_h
#define CmpiLinux_DnsQueryACLForServiceProvider_h
...
#include "CmpiAssociationMI.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_DnsQueryACLForServiceProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_DnsQueryACLForServiceInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_DnsQueryACLForServiceInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_DnsQueryACLForServiceInstanceName& intanceName);
