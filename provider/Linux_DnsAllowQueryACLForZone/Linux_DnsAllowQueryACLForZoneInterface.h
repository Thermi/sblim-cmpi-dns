...
namespace genProvider {
  ...
  class Linux_DnsAllowQueryACLForZoneInterface {
    ...
    virtual void enumInstanceNames(
      ...
      Linux_DnsAllowQueryACLForZoneInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_DnsAllowQueryACLForZoneManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_DnsAllowQueryACLForZoneManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_DnsAllowQueryACLForZoneInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_DnsAllowQueryACLForZoneManualInstance& aManualInstance) = 0;
