...
namespace genProvider{
  ...
  class CmpiLinux_DnsQueryACLForServiceProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsQueryACLForServiceInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsQueryACLForServiceInstanceName& anInstanceNameP,
