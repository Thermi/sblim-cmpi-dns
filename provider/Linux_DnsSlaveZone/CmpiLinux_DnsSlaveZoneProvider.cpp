...
namespace genProvider {
  ...
  CmpiLinux_DnsSlaveZoneProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_DnsSlaveZoneFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_DnsSlaveZoneProvider::
  ...
  int CmpiLinux_DnsSlaveZoneProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_DnsSlaveZoneProvider::completeInstance(
   const Linux_DnsSlaveZoneInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_DnsSlaveZoneInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_DnsSlaveZoneProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_DnsSlaveZoneProvider::
  ...
  void CmpiLinux_DnsSlaveZoneProvider::removeDanglingShadowInstances (
   const Linux_DnsSlaveZoneInstanceNameEnumeration& dinInsNames){
  ...
  CmpiStatus CmpiLinux_DnsSlaveZoneProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_DnsSlaveZoneProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
    ...
    while ( enumeration.hasNext() ){
   	  ...
   	  const Linux_DnsSlaveZoneManualInstance& instance=
       enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_DnsSlaveZoneProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_DnsSlaveZoneInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsSlaveZoneProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,const CmpiInstance& inst){
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_DnsSlaveZoneRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_DnsSlaveZoneProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_DnsSlaveZoneProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_DnsSlaveZoneInstanceName instanceName=
     Linux_DnsSlaveZoneInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsSlaveZoneProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_DnsSlaveZoneInstanceName instanceName=
     Linux_DnsSlaveZoneInstanceName(ref);
