 /**
 * CmpiLinux_DnsMastersOfSlaveZoneProvider.h
 *
 ...
 *
 */
#ifndef CmpiLinux_DnsMastersOfSlaveZoneProvider_h
#define CmpiLinux_DnsMastersOfSlaveZoneProvider_h
...
#include "CmpiAssociationMI.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_DnsMastersOfSlaveZoneProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_DnsMastersOfSlaveZoneInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_DnsMastersOfSlaveZoneInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_DnsMastersOfSlaveZoneInstanceName& intanceName);
