...
//
// 
#ifndef Linux_DnsForwardersForServiceDefaultImplementation_h
#define Linux_DnsForwardersForServiceDefaultImplementation_h
...
namespace genProvider {
  ...
  class Linux_DnsForwardersForServiceDefaultImplementation:
   public Linux_DnsForwardersForServiceInterface {
  	
    public:    
    virtual ~Linux_DnsForwardersForServiceDefaultImplementation() { };
