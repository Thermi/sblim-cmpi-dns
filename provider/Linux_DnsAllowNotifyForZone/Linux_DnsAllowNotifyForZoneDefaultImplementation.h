// =======================================================================
// Linux_DnsAllowNotifyForZoneDefaultImplementation.h
...
//
// 
#ifndef Linux_DnsAllowNotifyForZoneDefaultImplementation_h
#define Linux_DnsAllowNotifyForZoneDefaultImplementation_h
...
#include "Linux_DnsAllowNotifyForZoneInterface.h"


namespace genProvider {

  class Linux_DnsAllowNotifyForZoneDefaultImplementation:
   public Linux_DnsAllowNotifyForZoneInterface {
  	
    public:    
    virtual ~Linux_DnsAllowNotifyForZoneDefaultImplementation() { };
