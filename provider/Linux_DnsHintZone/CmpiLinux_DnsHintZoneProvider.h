 ...
 *
 */
#ifndef CmpiLinux_DnsHintZoneProvider_h
#define CmpiLinux_DnsHintZoneProvider_h

#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsHintZoneFactory.h"

 namespace genProvider{

  class CmpiLinux_DnsHintZoneProvider : public CmpiInstanceMI,
   public CmpiMethodMI{	
	
	private:

	Linux_DnsHintZoneInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_DnsHintZoneInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_DnsHintZoneInstanceName& intanceName);
