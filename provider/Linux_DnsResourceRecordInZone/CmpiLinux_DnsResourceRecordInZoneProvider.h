 /**
 * CmpiLinux_DnsResourceRecordInZoneProvider.h
 *
 ...
 *
 */
#ifndef CmpiLinux_DnsResourceRecordInZoneProvider_h
#define CmpiLinux_DnsResourceRecordInZoneProvider_h
...
#include "CmpiAssociationMI.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_DnsResourceRecordInZoneProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_DnsResourceRecordInZoneInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_DnsResourceRecordInZoneInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_DnsResourceRecordInZoneInstanceName& intanceName);
