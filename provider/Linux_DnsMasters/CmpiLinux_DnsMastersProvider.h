// =======================================================================
// CmpiLinux_DnsMastersProvider.h
...
//
// 
#ifndef CmpiLinux_DnsMastersProvider_h
#define CmpiLinux_DnsMastersProvider_h
...
namespace genProvider{
  ...
  class CmpiLinux_DnsMastersProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI {	
	
	  private:
	  Linux_DnsMastersInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsMastersInstanceName& anInstanceNameP,
