...
//
// 
#ifndef CmpiLinux_DnsForwardersProvider_h
#define CmpiLinux_DnsForwardersProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsForwardersFactory.h"


namespace genProvider{

  class CmpiLinux_DnsForwardersProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI {	
	
	  private:
	  Linux_DnsForwardersInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsForwardersInstanceName& anInstanceNameP,
