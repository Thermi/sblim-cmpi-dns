...
namespace genProvider {
  ...
  CmpiLinux_DnsAllowUpdateACLForZoneProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_DnsAllowUpdateACLForZoneFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_DnsAllowUpdateACLForZoneProvider::
  ...
  int CmpiLinux_DnsAllowUpdateACLForZoneProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_DnsAllowUpdateACLForZoneProvider::completeInstance(
   const Linux_DnsAllowUpdateACLForZoneInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_DnsAllowUpdateACLForZoneInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_DnsAllowUpdateACLForZoneProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_DnsAllowUpdateACLForZoneProvider::
  ...
  void CmpiLinux_DnsAllowUpdateACLForZoneProvider::removeDanglingShadowInstances (
   const Linux_DnsAllowUpdateACLForZoneInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_DnsAllowUpdateACLForZoneProvider, CmpiLinux_DnsAllowUpdateACLForZoneProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_DnsAllowUpdateACLForZoneProvider,
     CmpiLinux_DnsAllowUpdateACLForZoneProvider);
  ...
  CmpiStatus CmpiLinux_DnsAllowUpdateACLForZoneProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_DnsAllowUpdateACLForZoneProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_DnsAllowUpdateACLForZoneProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_DnsAllowUpdateACLForZoneInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsAllowUpdateACLForZoneProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,const CmpiInstance& inst){
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_DnsAllowUpdateACLForZoneRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_DnsAllowUpdateACLForZoneProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_DnsAllowUpdateACLForZoneProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_DnsAllowUpdateACLForZoneInstanceName instanceName=
     Linux_DnsAllowUpdateACLForZoneInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsAllowUpdateACLForZoneProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_DnsAllowUpdateACLForZoneInstanceName instanceName=
     Linux_DnsAllowUpdateACLForZoneInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_DnsAllowUpdateACLForZoneProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_DnsAllowUpdateACLForZoneManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_DnsAllowUpdateACLForZoneProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_DnsAllowUpdateACLForZone"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsAllowUpdateACLForZoneProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_DnsAllowUpdateACLForZone"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsAllowUpdateACLForZoneProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_DnsAllowUpdateACLForZone"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsAllowUpdateACLForZoneProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_DnsAllowUpdateACLForZone"<<endl;
