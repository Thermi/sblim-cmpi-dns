 /**
 * CmpiLinux_DnsAllowQueryACLForZoneProvider.h
 *
 ...
 *
 */
#ifndef CmpiLinux_DnsAllowQueryACLForZoneProvider_h
#define CmpiLinux_DnsAllowQueryACLForZoneProvider_h
...
#include "CmpiAssociationMI.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_DnsAllowQueryACLForZoneProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_DnsAllowQueryACLForZoneInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_DnsAllowQueryACLForZoneInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_DnsAllowQueryACLForZoneInstanceName& intanceName);
