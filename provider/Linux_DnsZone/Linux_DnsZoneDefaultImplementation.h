 /**
 * Linux_DnsZoneDefaultImplementation.h
 *
 ...
 *
 */
#ifndef Linux_DnsZoneDefaultImplementation_h
#define Linux_DnsZoneDefaultImplementation_h
...
#include "Linux_DnsZoneInterface.h"

namespace genProvider {

  class Linux_DnsZoneDefaultImplementation:
   public Linux_DnsZoneInterface {
  	
    public:    
    virtual ~Linux_DnsZoneDefaultImplementation() { };
