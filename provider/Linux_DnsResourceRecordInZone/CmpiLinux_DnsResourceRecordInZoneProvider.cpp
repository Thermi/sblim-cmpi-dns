 /**
 * CmpiLinux_DnsResourceRecordInZoneProvider.cpp
 *
 ...
 *
 */
#include "CmpiLinux_DnsResourceRecordInZoneProvider.h"
...
namespace genProvider {
  ...
  CmpiLinux_DnsResourceRecordInZoneProvider::
   CmpiLinux_DnsResourceRecordInZoneProvider (
   const CmpiBroker &mbp, const CmpiContext& ctx):
    CmpiBaseMI(mbp, ctx), CmpiInstanceMI(mbp,ctx),
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      
      interfaceP=Linux_DnsResourceRecordInZoneFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_DnsResourceRecordInZoneProvider::
  ...
  int CmpiLinux_DnsResourceRecordInZoneProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_DnsResourceRecordInZoneProvider::completeInstance(
   const Linux_DnsResourceRecordInZoneInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_DnsResourceRecordInZoneInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_DnsResourceRecordInZoneProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_DnsResourceRecordInZoneProvider::
  ...
  void CmpiLinux_DnsResourceRecordInZoneProvider::removeDanglingShadowInstances (
   const Linux_DnsResourceRecordInZoneInstanceNameEnumeration& dinInsNames){
  ...
  CMProviderBase(CmpiLinux_DnsResourceRecordInZoneProvider);

  CMInstanceMIFactory(
   CmpiLinux_DnsResourceRecordInZoneProvider, CmpiLinux_DnsResourceRecordInZoneProvider);

  CMMethodMIFactory(
   CmpiLinux_DnsResourceRecordInZoneProvider, CmpiLinux_DnsResourceRecordInZoneProvider);
    
    CMAssociationMIFactory( CmpiLinux_DnsResourceRecordInZoneProvider,
     CmpiLinux_DnsResourceRecordInZoneProvider);
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordInZoneProvider::enumInstanceNames (
   ...
   const CmpiObjectPath& cop){
    ...
    Linux_DnsResourceRecordInZoneInstanceNameEnumeration enumeration;
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordInZoneProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordInZoneProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_DnsResourceRecordInZoneInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordInZoneProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,const CmpiInstance& inst){
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_DnsResourceRecordInZoneRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordInZoneProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordInZoneProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_DnsResourceRecordInZoneInstanceName instanceName=
     Linux_DnsResourceRecordInZoneInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordInZoneProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_DnsResourceRecordInZoneInstanceName instanceName=
     Linux_DnsResourceRecordInZoneInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordInZoneProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      if(cop.classPathIsA("Linux_DnsZone")) {
        ...
        Linux_DnsZoneInstanceName GroupComponent(cop);
      ...
      else if(cop.classPathIsA("Linux_DnsResourceRecord")) {
        Linux_DnsZoneInstanceEnumeration enumeration;
        Linux_DnsResourceRecordInstanceName PartComponent(cop);
      ...
      if(cop.classPathIsA("Linux_DnsResourceRecord")) {
        Linux_DnsResourceRecordInstanceName PartComponent(cop);
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_DnsResourceRecordInZoneManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordInZoneProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_DnsResourceRecordInZone"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordInZoneProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_DnsResourceRecordInZone"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordInZoneProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_DnsResourceRecordInZone"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsResourceRecordInZoneProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_DnsResourceRecordInZone"<<endl;
