 /**
 * CmpiLinux_DnsBlackholeACLForServiceProvider.h
 *
 ...
 *
 */
#ifndef CmpiLinux_DnsBlackholeACLForServiceProvider_h
#define CmpiLinux_DnsBlackholeACLForServiceProvider_h
...
#include "CmpiAssociationMI.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_DnsBlackholeACLForServiceProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_DnsBlackholeACLForServiceInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_DnsBlackholeACLForServiceInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_DnsBlackholeACLForServiceInstanceName& intanceName);
