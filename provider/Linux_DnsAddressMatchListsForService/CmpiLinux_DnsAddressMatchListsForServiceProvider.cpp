...
//
// 
#include "CmpiLinux_DnsAddressMatchListsForServiceProvider.h"
...
namespace genProvider {
  ...
  //----------------------------------------------------------------------------
  CmpiLinux_DnsAddressMatchListsForServiceProvider::CmpiLinux_DnsAddressMatchListsForServiceProvider(
    ...
    m_interfaceP = Linux_DnsAddressMatchListsForServiceFactory::getImplementation();           
  ...
  //----------------------------------------------------------------------------
  int 
  CmpiLinux_DnsAddressMatchListsForServiceProvider::isUnloadable() const {
    return 0;
  }
	
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_DnsAddressMatchListsForServiceProvider::completeInstance(
    const Linux_DnsAddressMatchListsForServiceInstanceName& anInstanceName,
    CmpiInstance& anInstance, 
    const CmpiContext& aContext) {
	  	
    Linux_DnsAddressMatchListsForServiceInstanceName shadowInstanceName(anInstanceName);
  ...
  //----------------------------------------------------------------------------
  void 
  CmpiLinux_DnsAddressMatchListsForServiceProvider::copyShadowData(
  ...
  //----------------------------------------------------------------------------
  CmpiInstance* 
  CmpiLinux_DnsAddressMatchListsForServiceProvider::getShadowInstance(
  ...
  //----------------------------------------------------------------------------
  void
  CmpiLinux_DnsAddressMatchListsForServiceProvider::removeDanglingShadowInstances (
   const Linux_DnsAddressMatchListsForServiceInstanceNameEnumeration& anInstanceNameEnumerations) {
  ...
  //                          Provider Factory
  //----------------------------------------------------------------------------
  CMProviderBase(CmpiLinux_DnsAddressMatchListsForServiceProvider);

  CMInstanceMIFactory(
    CmpiLinux_DnsAddressMatchListsForServiceProvider, 
    CmpiLinux_DnsAddressMatchListsForServiceProvider);

  CMMethodMIFactory(
    CmpiLinux_DnsAddressMatchListsForServiceProvider, 
    CmpiLinux_DnsAddressMatchListsForServiceProvider);    CMAssociationMIFactory(
      CmpiLinux_DnsAddressMatchListsForServiceProvider,
      CmpiLinux_DnsAddressMatchListsForServiceProvider);
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAddressMatchListsForServiceProvider::enumInstanceNames(
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    ...
    Linux_DnsAddressMatchListsForServiceInstanceNameEnumeration enumeration;
    ...
    while (enumeration.hasNext() ){
      const Linux_DnsAddressMatchListsForServiceInstanceName& instanceName = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAddressMatchListsForServiceProvider::enumInstances(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop, 
    ...
    Linux_DnsAddressMatchListsForServiceManualInstanceEnumeration enumeration;
    ...
    while (enumeration.hasNext()) {
   	  const Linux_DnsAddressMatchListsForServiceManualInstance& instance = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAddressMatchListsForServiceProvider::getInstance (
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char** aPropertiesPP) {
    ...
    Linux_DnsAddressMatchListsForServiceInstanceName instanceName(aCop);
...
//    } catch (const CmpiStatus& rc) { }                             
    ...
    Linux_DnsAddressMatchListsForServiceManualInstance instance;
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAddressMatchListsForServiceProvider::createInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const CmpiInstance& aCmpiInstance) {
   	
   	Linux_DnsAddressMatchListsForServiceManualInstance manualInstance(
      aCmpiInstance,
...
//   	  Linux_DnsAddressMatchListsForServiceRepositoryInstance(aCmpiInstance,"IBMShadow/cimv2").getCmpiInstance(0);     
//     
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAddressMatchListsForServiceProvider::setInstance (
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const CmpiInstance& aCmpiInstance,
...
//    }
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_DnsAddressMatchListsForServiceProvider::deleteInstance(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop) {
      
    Linux_DnsAddressMatchListsForServiceInstanceName instanceName = Linux_DnsAddressMatchListsForServiceInstanceName(aCop);
...
//    } catch (CmpiStatus& rc) {}
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_DnsAddressMatchListsForServiceProvider::invokeMethod(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAddressMatchListsForServiceProvider::associationLogic( 
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    ...
    if( aReferenceFlag == 0 && anInstanceFlag == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_DnsAddressMatchListsForServiceManualInstance manualInstance = enumeration.getNext();
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAddressMatchListsForServiceProvider::associators(
    const CmpiContext& aContext, 
    CmpiResult& aResult,
    const CmpiObjectPath& aCop, 
...
#ifdef DEBUG
    std::cout << "calling associators() of class Linux_DnsAddressMatchListsForService" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus 
  CmpiLinux_DnsAddressMatchListsForServiceProvider::associatorNames(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling associatorNames() of class Linux_DnsAddressMatchListsForService" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_DnsAddressMatchListsForServiceProvider::references( 
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling aReferenceFlag() of class Linux_DnsAddressMatchListsForService" << std::endl;
#endif    
  ...
  //----------------------------------------------------------------------------
  CmpiStatus
  CmpiLinux_DnsAddressMatchListsForServiceProvider::referenceNames(
    const CmpiContext& aContext,
    CmpiResult& aResult,
    const CmpiObjectPath& aCop,
    const char* anAssociationClassnameP,
...
#ifdef DEBUG
    std::cout << "calling referenceNames() of class Linux_DnsAddressMatchListsForService" << std::endl;
#endif    
