...
//
// 
#ifndef CmpiLinux_DnsResourceRecordsForZoneProvider_h
#define CmpiLinux_DnsResourceRecordsForZoneProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsResourceRecordsForZoneFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_DnsResourceRecordsForZoneProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsResourceRecordsForZoneInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsResourceRecordsForZoneInstanceName& anInstanceNameP,
