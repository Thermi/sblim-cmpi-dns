...
//
// 
#ifndef Linux_DnsAllowTransferForZoneResourceAccess_h
#define Linux_DnsAllowTransferForZoneResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_DnsAllowTransferForZoneResourceAccess:
   public Linux_DnsAllowTransferForZoneDefaultImplementation {
  	
    public:
    /*
    Linux_DnsAllowTransferForZoneResourceAccess();
    */    
    virtual ~Linux_DnsAllowTransferForZoneResourceAccess() ;
