 /**
 * Linux_DnsResourceRecordInZoneDefaultImplementation.h
 *
 ...
 *
 */
#ifndef Linux_DnsResourceRecordInZoneDefaultImplementation_h
#define Linux_DnsResourceRecordInZoneDefaultImplementation_h
...
namespace genProvider {
  ...
  class Linux_DnsResourceRecordInZoneDefaultImplementation:
   public Linux_DnsResourceRecordInZoneInterface {
  	
    public:    
    virtual ~Linux_DnsResourceRecordInZoneDefaultImplementation() { };
