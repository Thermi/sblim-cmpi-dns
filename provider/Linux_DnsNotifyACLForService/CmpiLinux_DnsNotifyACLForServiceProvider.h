...
namespace genProvider{
  ...
  class CmpiLinux_DnsNotifyACLForServiceProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsNotifyACLForServiceInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsNotifyACLForServiceInstanceName& anInstanceNameP,
