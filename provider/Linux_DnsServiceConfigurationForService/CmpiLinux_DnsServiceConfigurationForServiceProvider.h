...
//
// 
#ifndef CmpiLinux_DnsServiceConfigurationForServiceProvider_h
#define CmpiLinux_DnsServiceConfigurationForServiceProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsServiceConfigurationForServiceFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_DnsServiceConfigurationForServiceProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsServiceConfigurationForServiceInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsServiceConfigurationForServiceInstanceName& anInstanceNameP,
