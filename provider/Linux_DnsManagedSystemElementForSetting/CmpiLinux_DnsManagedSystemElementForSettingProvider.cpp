...
namespace genProvider {
  ...
  CmpiLinux_DnsManagedSystemElementForSettingProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_DnsManagedSystemElementForSettingFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_DnsManagedSystemElementForSettingProvider::
  ...
  int CmpiLinux_DnsManagedSystemElementForSettingProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_DnsManagedSystemElementForSettingProvider::completeInstance(
   const Linux_DnsManagedSystemElementForSettingInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_DnsManagedSystemElementForSettingInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_DnsManagedSystemElementForSettingProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_DnsManagedSystemElementForSettingProvider::
  ...
  void CmpiLinux_DnsManagedSystemElementForSettingProvider::removeDanglingShadowInstances (
  ...
  CMMethodMIFactory(
   CmpiLinux_DnsManagedSystemElementForSettingProvider, CmpiLinux_DnsManagedSystemElementForSettingProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_DnsManagedSystemElementForSettingProvider,
     CmpiLinux_DnsManagedSystemElementForSettingProvider);
  ...
  CmpiStatus CmpiLinux_DnsManagedSystemElementForSettingProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_DnsManagedSystemElementForSettingProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_DnsManagedSystemElementForSettingProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_DnsManagedSystemElementForSettingInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsManagedSystemElementForSettingProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,const CmpiInstance& inst){
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_DnsManagedSystemElementForSettingRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_DnsManagedSystemElementForSettingProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_DnsManagedSystemElementForSettingProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_DnsManagedSystemElementForSettingInstanceName instanceName=
     Linux_DnsManagedSystemElementForSettingInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsManagedSystemElementForSettingProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_DnsManagedSystemElementForSettingInstanceName instanceName=
     Linux_DnsManagedSystemElementForSettingInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_DnsManagedSystemElementForSettingProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_DnsManagedSystemElementForSettingManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_DnsManagedSystemElementForSettingProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_DnsManagedSystemElementForSetting"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsManagedSystemElementForSettingProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_DnsManagedSystemElementForSetting"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsManagedSystemElementForSettingProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_DnsManagedSystemElementForSetting"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsManagedSystemElementForSettingProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_DnsManagedSystemElementForSetting"<<endl;
