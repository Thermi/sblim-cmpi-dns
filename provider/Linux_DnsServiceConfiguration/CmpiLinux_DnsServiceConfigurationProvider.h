 ...
 *
 */
#ifndef CmpiLinux_DnsServiceConfigurationProvider_h
#define CmpiLinux_DnsServiceConfigurationProvider_h
...
#include "CmpiAssociationMI.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_DnsServiceConfigurationProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_DnsServiceConfigurationInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_DnsServiceConfigurationInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_DnsServiceConfigurationInstanceName& intanceName);
