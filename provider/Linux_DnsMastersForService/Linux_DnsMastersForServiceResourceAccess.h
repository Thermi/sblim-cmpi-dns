...
//
// 
#ifndef Linux_DnsMastersForServiceResourceAccess_h
#define Linux_DnsMastersForServiceResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_DnsMastersForServiceResourceAccess:
   public Linux_DnsMastersForServiceDefaultImplementation {
  	
    public:
    /*
    Linux_DnsMastersForServiceResourceAccess();
    */    
    virtual ~Linux_DnsMastersForServiceResourceAccess() ;
