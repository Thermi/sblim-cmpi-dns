...
namespace genProvider {
  ...
  class Linux_DnsSettingInterface {
    ...
    virtual void enumInstanceNames(
     ...
     const char *nsp,
     Linux_DnsSettingInstanceNameEnumeration& instnames) = 0;
    ...
    virtual void enumInstances(
     ...
     const char* *properties,
  	 Linux_DnsSettingManualInstanceEnumeration& instances) = 0;
  	
    virtual Linux_DnsSettingManualInstance getInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_DnsSettingInstanceName&) = 0;
  	
    virtual void setInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_DnsSettingManualInstance&) = 0;
