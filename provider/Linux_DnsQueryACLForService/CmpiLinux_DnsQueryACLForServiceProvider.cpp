...
namespace genProvider {
  ...
  CmpiLinux_DnsQueryACLForServiceProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_DnsQueryACLForServiceFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_DnsQueryACLForServiceProvider::
  ...
  int CmpiLinux_DnsQueryACLForServiceProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_DnsQueryACLForServiceProvider::completeInstance(
   const Linux_DnsQueryACLForServiceInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_DnsQueryACLForServiceInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_DnsQueryACLForServiceProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_DnsQueryACLForServiceProvider::
  ...
  void CmpiLinux_DnsQueryACLForServiceProvider::removeDanglingShadowInstances (
   const Linux_DnsQueryACLForServiceInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_DnsQueryACLForServiceProvider, CmpiLinux_DnsQueryACLForServiceProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_DnsQueryACLForServiceProvider,
     CmpiLinux_DnsQueryACLForServiceProvider);
  ...
  CmpiStatus CmpiLinux_DnsQueryACLForServiceProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_DnsQueryACLForServiceProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_DnsQueryACLForServiceProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_DnsQueryACLForServiceInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsQueryACLForServiceProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   ...
   /* 
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_DnsQueryACLForServiceRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_DnsQueryACLForServiceProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_DnsQueryACLForServiceProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_DnsQueryACLForServiceInstanceName instanceName=
     Linux_DnsQueryACLForServiceInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsQueryACLForServiceProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_DnsQueryACLForServiceInstanceName instanceName=
     Linux_DnsQueryACLForServiceInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_DnsQueryACLForServiceProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_DnsQueryACLForServiceManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_DnsQueryACLForServiceProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_DnsQueryACLForService"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsQueryACLForServiceProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_DnsQueryACLForService"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsQueryACLForServiceProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_DnsQueryACLForService"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsQueryACLForServiceProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_DnsQueryACLForService"<<endl;
