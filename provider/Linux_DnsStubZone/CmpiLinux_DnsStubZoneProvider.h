...
//
// 
#ifndef CmpiLinux_DnsStubZoneProvider_h
#define CmpiLinux_DnsStubZoneProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsStubZoneFactory.h"


namespace genProvider{

  class CmpiLinux_DnsStubZoneProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI {	
	
	  private:
	  Linux_DnsStubZoneInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsStubZoneInstanceName& anInstanceNameP,
