...
//
// 
#ifndef CmpiLinux_DnsMastersForZoneProvider_h
#define CmpiLinux_DnsMastersForZoneProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsMastersForZoneFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_DnsMastersForZoneProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsMastersForZoneInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsMastersForZoneInstanceName& anInstanceNameP,
