...
//
// 
#ifndef Linux_DnsAllowUpdateForZoneDefaultImplementation_h
#define Linux_DnsAllowUpdateForZoneDefaultImplementation_h
...
#include "Linux_DnsAllowUpdateForZoneInterface.h"


namespace genProvider {

  class Linux_DnsAllowUpdateForZoneDefaultImplementation:
   public Linux_DnsAllowUpdateForZoneInterface {
  	
    public:    
    virtual ~Linux_DnsAllowUpdateForZoneDefaultImplementation() { };
