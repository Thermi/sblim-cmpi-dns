...
//
// 
#ifndef Linux_DnsResourceRecordsForZoneDefaultImplementation_h
#define Linux_DnsResourceRecordsForZoneDefaultImplementation_h
...
namespace genProvider {
  ...
  class Linux_DnsResourceRecordsForZoneDefaultImplementation:
   public Linux_DnsResourceRecordsForZoneInterface {
  	
    public:    
    virtual ~Linux_DnsResourceRecordsForZoneDefaultImplementation() { };
