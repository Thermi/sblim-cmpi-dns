...
namespace genProvider {
  ...
  class Linux_DnsElementSettingInterface {
    ...
    virtual void enumInstanceNames(
      ...
      Linux_DnsElementSettingInstanceNameEnumeration& anInstanceNameEnumeration) = 0;
    ...
    virtual void enumInstances(
      ...
      const char** aPropertiesPP,
  	  Linux_DnsElementSettingManualInstanceEnumeration& aManualInstanceEnumeration) = 0;
    ...
    virtual Linux_DnsElementSettingManualInstance getInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_DnsElementSettingInstanceName& anInstanceName) = 0;
    ...
    virtual void setInstance(
      ...
      const CmpiBroker& aBroker,
      const char** aPropertiesPP,
      const Linux_DnsElementSettingManualInstance& aManualInstance) = 0;
