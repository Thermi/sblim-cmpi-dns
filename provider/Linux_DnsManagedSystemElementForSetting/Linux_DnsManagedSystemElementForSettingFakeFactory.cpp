 /**
 * Linux_DnsManagedSystemElementForSettingFakeFactory.cpp
 *
...
namespace genProvider{
	...
	Linux_DnsManagedSystemElementForSettingInterface* 
	  Linux_DnsManagedSystemElementForSettingFactory::getImplementation(){
	  	
	  	cout<<"ERROR: incomplete support library is being used"<<endl;
	  	cout<<"       in provider from class Linux_DnsManagedSystemElementForSetting"<<endl;
