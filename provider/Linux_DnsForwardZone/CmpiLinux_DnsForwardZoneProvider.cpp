 ...
 *
 */
#include "CmpiLinux_DnsForwardZoneProvider.h"
...
namespace genProvider {
  ...
  CmpiLinux_DnsForwardZoneProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_DnsForwardZoneFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_DnsForwardZoneProvider::
  ...
  int CmpiLinux_DnsForwardZoneProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_DnsForwardZoneProvider::completeInstance(
   const Linux_DnsForwardZoneInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_DnsForwardZoneInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_DnsForwardZoneProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_DnsForwardZoneProvider::
  ...
  void CmpiLinux_DnsForwardZoneProvider::removeDanglingShadowInstances (
   const Linux_DnsForwardZoneInstanceNameEnumeration& dinInsNames){
  ...
  CMProviderBase(CmpiLinux_DnsForwardZoneProvider);
  ...
  CmpiStatus CmpiLinux_DnsForwardZoneProvider::enumInstanceNames (
   ...
   const CmpiObjectPath& cop){
    ...
    Linux_DnsForwardZoneInstanceNameEnumeration enumeration;
  ...
  CmpiStatus CmpiLinux_DnsForwardZoneProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
    ...
    Linux_DnsForwardZoneManualInstanceEnumeration enumeration;
    ...
    while ( enumeration.hasNext() ){
   	  ...
   	  const Linux_DnsForwardZoneManualInstance& instance=
       enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_DnsForwardZoneProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_DnsForwardZoneInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsForwardZoneProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,const CmpiInstance& inst){
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_DnsForwardZoneRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_DnsForwardZoneProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_DnsForwardZoneProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_DnsForwardZoneInstanceName instanceName=
     Linux_DnsForwardZoneInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsForwardZoneProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_DnsForwardZoneInstanceName instanceName=
     Linux_DnsForwardZoneInstanceName(ref);
