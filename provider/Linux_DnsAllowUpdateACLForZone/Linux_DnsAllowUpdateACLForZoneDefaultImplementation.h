 /**
 * Linux_DnsAllowUpdateACLForZoneDefaultImplementation.h
 *
 ...
 *
 */
#ifndef Linux_DnsAllowUpdateACLForZoneDefaultImplementation_h
#define Linux_DnsAllowUpdateACLForZoneDefaultImplementation_h
...
namespace genProvider {
  ...
  class Linux_DnsAllowUpdateACLForZoneDefaultImplementation:
   public Linux_DnsAllowUpdateACLForZoneInterface {
  	
    public:    
    virtual ~Linux_DnsAllowUpdateACLForZoneDefaultImplementation() { };
