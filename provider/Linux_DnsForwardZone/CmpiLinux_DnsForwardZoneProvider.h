 ...
 *
 */
#ifndef CmpiLinux_DnsForwardZoneProvider_h
#define CmpiLinux_DnsForwardZoneProvider_h
...
#include "Linux_DnsForwardZoneFactory.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_DnsForwardZoneProvider : public CmpiInstanceMI,
   public CmpiMethodMI{	
	
	private:

	Linux_DnsForwardZoneInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_DnsForwardZoneInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_DnsForwardZoneInstanceName& intanceName);
