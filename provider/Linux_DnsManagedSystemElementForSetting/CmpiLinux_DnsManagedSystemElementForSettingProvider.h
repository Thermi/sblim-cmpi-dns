...
namespace genProvider{
  ...
  class CmpiLinux_DnsManagedSystemElementForSettingProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsManagedSystemElementForSettingInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsManagedSystemElementForSettingInstanceName& anInstanceNameP,
