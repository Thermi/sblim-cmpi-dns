 /**
 * CmpiLinux_DnsAllowUpdateACLForZoneProvider.h
 *
 ...
 *
 */
#ifndef CmpiLinux_DnsAllowUpdateACLForZoneProvider_h
#define CmpiLinux_DnsAllowUpdateACLForZoneProvider_h
...
#include "CmpiAssociationMI.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_DnsAllowUpdateACLForZoneProvider : public CmpiInstanceMI,
   public CmpiMethodMI, public CmpiAssociationMI{	
	
	private:

	Linux_DnsAllowUpdateACLForZoneInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_DnsAllowUpdateACLForZoneInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_DnsAllowUpdateACLForZoneInstanceName& intanceName);
