...
namespace genProvider {
  ...
  CmpiLinux_DnsElementSettingProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_DnsElementSettingFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_DnsElementSettingProvider::
  ...
  int CmpiLinux_DnsElementSettingProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_DnsElementSettingProvider::completeInstance(
   const Linux_DnsElementSettingInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_DnsElementSettingInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_DnsElementSettingProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_DnsElementSettingProvider::
  ...
  void CmpiLinux_DnsElementSettingProvider::removeDanglingShadowInstances (
   const Linux_DnsElementSettingInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_DnsElementSettingProvider, CmpiLinux_DnsElementSettingProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_DnsElementSettingProvider,
     CmpiLinux_DnsElementSettingProvider);
  ...
  CmpiStatus CmpiLinux_DnsElementSettingProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_DnsElementSettingProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_DnsElementSettingProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_DnsElementSettingInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsElementSettingProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_DnsElementSettingProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_DnsElementSettingProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_DnsElementSettingInstanceName instanceName=
     Linux_DnsElementSettingInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsElementSettingProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_DnsElementSettingInstanceName instanceName=
     Linux_DnsElementSettingInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_DnsElementSettingProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_DnsElementSettingManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_DnsElementSettingProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_DnsElementSetting"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsElementSettingProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_DnsElementSetting"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsElementSettingProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_DnsElementSetting"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsElementSettingProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_DnsElementSetting"<<endl;
