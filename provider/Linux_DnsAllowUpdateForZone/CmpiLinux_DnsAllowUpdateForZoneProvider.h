...
//
// 
#ifndef CmpiLinux_DnsAllowUpdateForZoneProvider_h
#define CmpiLinux_DnsAllowUpdateForZoneProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsAllowUpdateForZoneFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_DnsAllowUpdateForZoneProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsAllowUpdateForZoneInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsAllowUpdateForZoneInstanceName& anInstanceNameP,
