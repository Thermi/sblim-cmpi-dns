...
//
// 
#ifndef Linux_DnsServiceConfigurationForServiceDefaultImplementation_h
#define Linux_DnsServiceConfigurationForServiceDefaultImplementation_h
...
#include "Linux_DnsServiceConfigurationForServiceInterface.h"


namespace genProvider {

  class Linux_DnsServiceConfigurationForServiceDefaultImplementation:
   public Linux_DnsServiceConfigurationForServiceInterface {
  	
    public:    
    virtual ~Linux_DnsServiceConfigurationForServiceDefaultImplementation() { };
