 ...
 *
 */
#ifndef CmpiLinux_DnsZoneProvider_h
#define CmpiLinux_DnsZoneProvider_h
...
#include "Linux_DnsZoneFactory.h"
 ...
 namespace genProvider{
  ...
  class CmpiLinux_DnsZoneProvider : public CmpiInstanceMI,
   public CmpiMethodMI{	
	
	private:

	Linux_DnsZoneInterface* interfaceP;
	const static char * shadowNameSpaceP;
	CmpiBroker cppBroker;
	    
    void completeInstance (
     const Linux_DnsZoneInstanceName& intanceNameP,
    ...
    CmpiInstance* getShadowInstance (
     ...
     const Linux_DnsZoneInstanceName& intanceName);
