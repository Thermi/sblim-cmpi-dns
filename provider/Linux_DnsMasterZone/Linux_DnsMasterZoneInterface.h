...
namespace genProvider {
  ...
  class Linux_DnsMasterZoneInterface {
    ...
    virtual void enumInstanceNames(
     ...
     const char *nsp,
     Linux_DnsMasterZoneInstanceNameEnumeration& instnames) = 0;
    ...
    virtual void enumInstances(
     ...
     const char* *properties,
  	 Linux_DnsMasterZoneManualInstanceEnumeration& instances) = 0;
  	
    virtual Linux_DnsMasterZoneManualInstance getInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_DnsMasterZoneInstanceName&) = 0;
  	
    virtual void setInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
     const Linux_DnsMasterZoneManualInstance&) = 0;
