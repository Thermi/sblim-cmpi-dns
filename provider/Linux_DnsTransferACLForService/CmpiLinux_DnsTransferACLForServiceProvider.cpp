...
namespace genProvider {
  ...
  CmpiLinux_DnsTransferACLForServiceProvider::
   ...
   const CmpiBroker &mbp, const CmpiContext& ctx):
    ...
    CmpiMethodMI(mbp,ctx), CmpiAssociationMI(mbp,ctx), cppBroker(mbp) {
      ...
      interfaceP=Linux_DnsTransferACLForServiceFactory::getImplementation();           
      cout<<"Provider was constructed"<<endl;
  };
    
        
  const char * CmpiLinux_DnsTransferACLForServiceProvider::
  ...
  int CmpiLinux_DnsTransferACLForServiceProvider::isUnloadable() const{
    return 0;
  }
  ...
  void CmpiLinux_DnsTransferACLForServiceProvider::completeInstance(
   const Linux_DnsTransferACLForServiceInstanceName& instanceName,
   CmpiInstance& target, const CmpiContext& ctx){
	  	
    Linux_DnsTransferACLForServiceInstanceName shadowInstanceName(instanceName);
  ...
  void CmpiLinux_DnsTransferACLForServiceProvider::copyShadowData (
  ...
  CmpiInstance* CmpiLinux_DnsTransferACLForServiceProvider::
  ...
  void CmpiLinux_DnsTransferACLForServiceProvider::removeDanglingShadowInstances (
   const Linux_DnsTransferACLForServiceInstanceNameEnumeration& dinInsNames){
  ...
  CMMethodMIFactory(
   CmpiLinux_DnsTransferACLForServiceProvider, CmpiLinux_DnsTransferACLForServiceProvider);
    ...
    CMAssociationMIFactory( CmpiLinux_DnsTransferACLForServiceProvider,
     CmpiLinux_DnsTransferACLForServiceProvider);
  ...
  CmpiStatus CmpiLinux_DnsTransferACLForServiceProvider::enumInstanceNames (
  ...
  CmpiStatus CmpiLinux_DnsTransferACLForServiceProvider::enumInstances (
   const CmpiContext& ctx, CmpiResult& rslt,
  ...
  CmpiStatus CmpiLinux_DnsTransferACLForServiceProvider::getInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const char* *properties){
     	
    //covert to instanceName
    Linux_DnsTransferACLForServiceInstanceName instanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsTransferACLForServiceProvider::createInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   ...
   /* 
    ...
    CmpiInstance* backupShadowInstance=0;
     ...
     Linux_DnsTransferACLForServiceRepositoryInstance(inst,shadowNameSpaceP)
     .getCmpiInstance(0);     
  ...
  CmpiStatus CmpiLinux_DnsTransferACLForServiceProvider::setInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, const CmpiInstance& inst,
  ...
  CmpiStatus CmpiLinux_DnsTransferACLForServiceProvider::deleteInstance (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop){
      
    Linux_DnsTransferACLForServiceInstanceName instanceName=
     Linux_DnsTransferACLForServiceInstanceName(cop);
  ...
  CmpiStatus CmpiLinux_DnsTransferACLForServiceProvider::invokeMethod (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& ref, const char* methodName,
   const CmpiArgs& in, CmpiArgs& out){
     	
    Linux_DnsTransferACLForServiceInstanceName instanceName=
     Linux_DnsTransferACLForServiceInstanceName(ref);
  ...
  CmpiStatus CmpiLinux_DnsTransferACLForServiceProvider::associationLogic( 
   ...
   const char** properties) {
    ...
    if( references == 0 && instances == 1 ) {
      ...
      while(enumeration.hasNext()) {
        ...
        const Linux_DnsTransferACLForServiceManualInstance manualInstance =
         enumeration.getNext();
  ...
  CmpiStatus CmpiLinux_DnsTransferACLForServiceProvider::associators (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop, 
   ...
   const char** properties) {
    ...
    cout<<"calling associators() of class Linux_DnsTransferACLForService"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsTransferACLForServiceProvider::associatorNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * resultClass,
   const char * role, const char * resultRole) {
   
    cout<<"calling associatorNames() of class Linux_DnsTransferACLForService"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsTransferACLForServiceProvider::references ( 
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role,
   const char** properties) {
    
    cout<<"calling references() of class Linux_DnsTransferACLForService"<<endl;
  ...
  CmpiStatus CmpiLinux_DnsTransferACLForServiceProvider::referenceNames (
   const CmpiContext& ctx, CmpiResult& rslt,
   const CmpiObjectPath& cop,
   const char * assocClass, const char * role) {
   
    cout<<"calling referenceNames() of class Linux_DnsTransferACLForService"<<endl;
