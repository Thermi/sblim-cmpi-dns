// =======================================================================
// Linux_DnsMastersDefaultImplementation.h
...
//
// 
#ifndef Linux_DnsMastersDefaultImplementation_h
#define Linux_DnsMastersDefaultImplementation_h
...
#include "Linux_DnsMastersInterface.h"


namespace genProvider {

  class Linux_DnsMastersDefaultImplementation:
   public Linux_DnsMastersInterface {
  	
    public:    
    virtual ~Linux_DnsMastersDefaultImplementation() { };
