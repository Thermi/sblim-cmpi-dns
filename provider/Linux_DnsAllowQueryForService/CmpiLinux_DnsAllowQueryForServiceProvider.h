...
//
// 
#ifndef CmpiLinux_DnsAllowQueryForServiceProvider_h
#define CmpiLinux_DnsAllowQueryForServiceProvider_h



#include "CmpiInstanceMI.h"
#include "CmpiMethodMI.h"
#include "Linux_DnsAllowQueryForServiceFactory.h"
#include "CmpiAssociationMI.h"


namespace genProvider{

  class CmpiLinux_DnsAllowQueryForServiceProvider : 
    public CmpiInstanceMI,
    public CmpiMethodMI, public CmpiAssociationMI {	
	
	  private:
	  Linux_DnsAllowQueryForServiceInterface* m_interfaceP;
	  CmpiBroker m_cmpiBroker;
	    
	  private:

    void completeInstance(
      const Linux_DnsAllowQueryForServiceInstanceName& anInstanceNameP,
