...
//
// 
#ifndef Linux_DnsBlackholeForServiceResourceAccess_h
#define Linux_DnsBlackholeForServiceResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_DnsBlackholeForServiceResourceAccess:
   public Linux_DnsBlackholeForServiceDefaultImplementation {
  	
    public:
    /*
    Linux_DnsBlackholeForServiceResourceAccess();
    */    
    virtual ~Linux_DnsBlackholeForServiceResourceAccess() ;
