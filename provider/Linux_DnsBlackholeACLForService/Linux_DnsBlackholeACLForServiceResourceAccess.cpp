...
namespace genProvider {
    ...
    void Linux_DnsBlackholeACLForServiceResourceAccess::enumInstanceNames(
    ...
    void Linux_DnsBlackholeACLForServiceResourceAccess::enumInstances(
	...
	return manualInst;
  	...
  	/*
    void Linux_DnsBlackholeACLForServiceResourceAccess::setInstance(
     const CmpiContext& ctx,
     const CmpiBroker &mbp,
     const char* *properties,
    ...
    void Linux_DnsBlackholeACLForServiceResourceAccess::createInstance(
    ...
    void Linux_DnsBlackholeACLForServiceResourceAccess::deleteInstance(
     const CmpiContext& ctx, const CmpiBroker &mbp,
    ...
    /* We support only one local service, so we just return it */
    void Linux_DnsBlackholeACLForServiceResourceAccess::referencesElement( 
     ...
     Linux_DnsBlackholeACLForServiceManualInstanceEnumeration& instEnum) {
