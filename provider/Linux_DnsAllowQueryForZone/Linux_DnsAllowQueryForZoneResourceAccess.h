...
//
// 
#ifndef Linux_DnsAllowQueryForZoneResourceAccess_h
#define Linux_DnsAllowQueryForZoneResourceAccess_h
...
namespace genProvider {
  ...
  class Linux_DnsAllowQueryForZoneResourceAccess:
   public Linux_DnsAllowQueryForZoneDefaultImplementation {
  	
    public:
    /*
    Linux_DnsAllowQueryForZoneResourceAccess();
    */    
    virtual ~Linux_DnsAllowQueryForZoneResourceAccess() ;
